...
const SearchAndNotification = ({ setOpenSearch, openSearch }) => {
  return (
    <>
      <div className="flex items-center text-text_primary gap-6">
        <div className="relative cursor-pointer">
          ...
          <span className="flex absolute h-3 w-3 rounded-full top-0 right-0 bg-primary_color  justify-center items-center">
